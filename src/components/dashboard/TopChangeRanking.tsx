  ...
  return (
    <Card>
      <CardTitle
        subtitle={
          tradeDate
            ? `기준일 ${tradeDate} · ${marketLabel} · 증가 상위 30`
            : "데이터 없음"
        }
      >
      ...
      {entries.length === 0 ? (
        <p className="py-8 text-center text-sm text-slate-500">랭킹 데이터가 없습니다.</p>
      ) : (
        <div className="max-h-[520px] overflow-y-auto rounded-lg border border-slate-100 dark:border-slate-800">
